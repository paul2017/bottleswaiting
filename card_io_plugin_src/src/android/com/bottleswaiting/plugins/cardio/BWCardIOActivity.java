package com.bottleswaiting.plugins.cardio;
...
public class BWCardIOActivity extends Activity
{
	//the plugin should creat this activity
	private static int MY_SCAN_REQUEST_CODE=10010;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) 
	{
	    ...
	    if (requestCode == MY_SCAN_REQUEST_CODE) {
			...
			if (data != null && data.hasExtra(CardIOActivity.EXTRA_SCAN_RESULT)) {
	            ...
	            carddata.put(j);
	            BWCardIOPlugin.mCreditcardNumber = carddata;
	        }
	    }
	    BWCardIOActivity.this.finish();
	}
}